...
public class HTMLBuilder extends Builder {
    ...
    public void builderTitle(String title) {                                           // HTML文件的标题
    ...
    public void builderString(String str) {                                            // HTML文件中的字符串
        writer.println("<p>" + str + "</p>");                                       // 用<p>标签输出
    }
    public void builderItems(String[] items) {                                         // HTML文件中的条目
